...
> [!NOTE]
> Out of an abundance of caution, and considering data sovereignity and enshitification, we [now mirror our most valuable assest on Codeberg](https://codeberg.org/bluegreen-labs).
...
- [daymetr](https://github.com/bluegreen-labs/daymetr) - high resolution climatology DAYMET data for North America - ![](https://cranlogs.r-pkg.org/badges/grand-total/daymetr) ![](https://www.r-pkg.org/badges/version/daymetr)  (☠️end-of-life☠️)
...
- [skytrackr](https://github.com/bluegreen-labs/skytrackr) - geolocation by light using a physical sky illuminance model - ![](https://cranlogs.r-pkg.org/badges/grand-total/skytrackr) ![](https://www.r-pkg.org/badges/version/skytrackr)
